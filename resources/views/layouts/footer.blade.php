<footer class="px-8 mt-8 w-full min-h-36 bg-neutral-800 text-neutral-300 sticky text-sm">
    <div class="container grid grid-cols-1 md:grid-cols-3 mx-auto py-4 space-x-8">
        <section class="col-span-1 flex flex-col justify-start gap-2">
            <p xmlns:cc="http://creativecommons.org/ns#" xmlns:dct="http://purl.org/dc/terms/">
                <a property="dct:title" rel="cc:attributionURL"
                   href="https://laravel-bootcamp.screencraft.net.au"
                   class="hover:text-neutral-200  underline underline-offset-2">
                    Laravel Bootcamp (Enchanced)</a>
                by
                <a rel="cc:attributionURL dct:creator" property="cc:attributionName"
                   href="https://adygcode.github.io" class="hover:text-neutral-200 underline underline-offset-2">
                    Adrian Gould</a>
                is licensed under
        ...
        <section class="col-span-1 gap-2 flex flex-wrap">
        ...
        <section class="col-span-1 flex flex-col
                        gap-2 justify-start          p-4
                        bg-amber-900 text-amber-500 font-light
                        rounded-lg shadow">
            <p>
                We acknowledge all Aboriginal and Torres Strait Islander Traditional Custodians of
                Country and recognize their continuing connection to land, sea, culture and community.
            </p>
            <p>
                We pay our
                respects to Elders past, present and future.</p>
        </section>
    </div>
</footer>
